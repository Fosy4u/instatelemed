...
class CountDown extends Component {
  ...
  componentDidMount() {
    this.deadline = new Date("August 01, 2022 21:00:00").getTime();
      ...
      <div id="countdown">
        <div className="timer">
          <div className="col-4">
            <div className="box">
              <p id="day">{days}</p>
              <strong className="text">Days</strong>
            </div>
          </div>
          <div className="col-4">
            <div className="box">
              <p id="hour">{hours}</p>
              <strong className="text">Hours</strong>
            </div>
          </div>
          <div className="col-4">
            <div className="box">
              <p id="minute">{minutes}</p>
              <strong className="text">Minutes</strong>
            </div>
          </div>
          <div className="col-4">
            <div className="box">
              <p id="second">{seconds}</p>
              <strong className="text">Seconds</strong>
            </div>
          </div>
        </div>
      </div>
